...
<table>
	...
	<tr>
		...
		<td>
			<input type="text" value="<% out.println(calc.getOp1()); %>"
			 size="10" style="text-align: center" readonly /><br>
			<jsp:getProperty property="operator" name="calc"/><br>
			<input type="text" value="<% out.println(calc.getOp2()); %>"
			 size="10" style="text-align: center" readonly/><br>
			=<br>
			<input type="text" value="<% out.println(calc.calc()); %>"
			 size="10" style="text-align: center" readonly/><br>
		</td>
    </tr>
    <tr>
